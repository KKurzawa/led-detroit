        ...
        <>
            <div className='landing-main-two'>
                <main className='landing-main  flex flex-col items-center w-full h-full'>
                    ...
                    <article className='landing-body flex flex-col items-center justify-evenly w-full h-full py-12 md:py-10 lg:py-28'>
                        <h1 className='led-detroit flex justify-center items-center text-7xl md:text-9xl font-bold w-fit h-fit px-4 pb-4 pt-6 mt-5 md:mt-0 lg:mt-7 mb-14 md:mb-10 lg:mb-16 rounded-2xl'>LED-DETROIT</h1>
                        {/* small */}
