...
const ContactForm = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='contact-form flex flex-col items-center w-full h-auto'>
            <input className='name w-1/3 px-3 py-1 mb-2 mt-10 text-3xl rounded-3xl'
                type='text'
                placeholder='Your Name'
                value={name}
                onChange={(e) => setName(e.target.value)}
            />
            <input className='email w-1/3 px-3 py-1 my-2 text-3xl rounded-3xl'
                type='text'
                placeholder='Your Email'
                value={email}
                onChange={(e) => setEmail(e.target.value)}
            />
            <input className='subject w-1/3 px-3 py-1 my-2 text-3xl rounded-3xl'
                type='text'
                placeholder='Your Subject'
                value={subject}
                onChange={(e) => setSubject(e.target.value)}
            />
            <textarea className='message w-1/3 px-3 py-1 my-2 text-3xl rounded-3xl'
                type='text'
                rows='5'
                cols='10'
